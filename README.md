...
| **Files** | [![FileBrowser](https://img.shields.io/badge/FileBrowser-455A64?style=flat-square&logo=files&logoColor=white)](https://github.com/gtsteffaniak/filebrowser) | `gtstef/filebrowser:stable` | `8082` | Web file manager for the data drive |
| | [![Samba](https://img.shields.io/badge/Samba-4E5A65?style=flat-square&logo=server&logoColor=white)](https://www.samba.org) | native, not a container | `139`, `445` | SMB share of the data drive |
| | [![MicroBin](https://img.shields.io/badge/MicroBin-6E4B9E?style=flat-square&logo=paste&logoColor=white)](https://microbin.eu) | `danielszabo99/microbin` | `8083` | Paste text and small files between machines |
...
| | [![Arcane](https://img.shields.io/badge/Arcane-0F766E?style=flat-square&logo=docker&logoColor=white)](https://github.com/getarcaneapp/arcane) | `ghcr.io/getarcaneapp/manager` | `3552` | Docker web UI. **Root-equivalent** — treat as such |
| | [![starbase-80](https://img.shields.io/badge/starbase--80-5B6478?style=flat-square&logo=dashboard&logoColor=white)](https://github.com/notclickable-jordan/starbase-80) | `jordanroher/starbase-80` | `8084` | Dashboard linking to everything above |
| **Monitoring** | [![Beszel](https://img.shields.io/badge/Beszel-2F855A?style=flat-square&logo=monitor&logoColor=white)](https://beszel.dev) | `henrygd/beszel` | `8086` | CPU, memory, disk, SMART history |
| | [![Dozzle](https://img.shields.io/badge/Dozzle-3A7BD5?style=flat-square&logo=terminal&logoColor=white)](https://dozzle.dev) | `amir20/dozzle` | `8085` | Live container logs |
| | [![Diun](https://img.shields.io/badge/Diun-795548?style=flat-square&logo=bell&logoColor=white)](https://crazymax.dev/diun/) | `crazymax/diun` | — | Notifies when an image goes stale |
